...
async function getLLMs(apiServer: string, apiKey: string) {
	const llmTypePromise = fetch(`${apiServer}/api/v1/settings/llm_type/`, {
		headers: {
...
async function getTTSs(apiServer: string, apiKey: string) {
	const ttsTypePromise = fetch(`${apiServer}/api/v1/settings/tts_type/`, {
		headers: {
			'PersoLive-APIKey': apiKey
		},
		method: 'GET'
...
async function getModelStyles(apiServer: string, apiKey: string) {
	const modelStylePromise = fetch(`${apiServer}/api/v1/settings/modelstyle/`, {
		headers: {
			'PersoLive-APIKey': apiKey
		},
		method: 'GET'
...
async function getBackgroundImages(apiServer: string, apiKey: string) {
	const backgroundImagesPromise = fetch(`${apiServer}/api/v1/background_image/`, {
		headers: {
			'PersoLive-APIKey': apiKey
		},
		method: 'GET'
...
async function getPrompts(apiServer: string, apiKey: string) {
	const promptPromise = fetch(`${apiServer}/api/v1/prompt/`, {
		headers: {
			'PersoLive-APIKey': apiKey
		},
		method: 'GET'
...
async function getDocuments(apiServer: string, apiKey: string) {
	const documentsPromise = fetch(`${apiServer}/api/v1/document/`, {
		headers: {
			'PersoLive-APIKey': apiKey
		},
		method: 'GET'
